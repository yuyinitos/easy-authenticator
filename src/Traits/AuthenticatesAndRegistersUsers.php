...
trait AuthenticatesAndRegistersUsers {
    ...
    {
        return view('socialAuthenticator::register');
    }
    ...
    public function redirectPath()
    {
        ...
        return property_exists($this, 'redirectTo') ? $this->redirectTo : Config::get('socialAuthenticator.login_redirect');
    }
    ...
    {
        return property_exists($this, 'loginPath') ? $this->loginPath : Config::get('socialAuthenticator.login_page');
    }
